...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Suppress stabile tests so that 'scan' can run the fragile tests again}
  spec.homepage      = "https://github.com/lyndsey-ferguson/fastlane_plugins/tree/master/fastlane-plugin-setup_fragile_tests_for_rescan"
  spec.license       = "MIT"
